...
## 💻 Core Features Built
- **Role-Based Access Control:** Secure Login/Signup for `student`, `mentor`, and `admin` roles.
...
- **Submissions Hub:** Submit GitHub repo links. Status tracks dynamically (`pending`, `approved`, `rejected`).
